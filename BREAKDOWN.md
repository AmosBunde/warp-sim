...
Issue numbers below are plan numbers; the GitHub numbers are assigned when the issues are opened and are recorded back here in the same pull request that closes the first issue of each milestone.
